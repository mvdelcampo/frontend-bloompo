...
export default function RegisterScreen() {
  return (
      ...
      <View style={styles.container}>
        ...
        <Text style={styles.title}>Crea hábitos. Cuida a tu mascota. Conéctate con amigos.</Text>
        <Text style={styles.subtitle}>Empieza tu viaje de crecimiento personal y grupal creando pequeños desafíos.
Sube pruebas, gana monedas, recibe apoyo de tu grupo y ve cómo tu mascota virtual florece contigo.</Text>
